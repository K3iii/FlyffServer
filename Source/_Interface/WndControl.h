...
public:
	...
	CTexture* m_pTexButtHScrBar;
	CTexture* m_pTexButtHScrPLeft;
	CTexture* m_pTexButtHScrPRight;
	CTexture* m_pTexButtHScrPBar;
...
public:
	void SetStringBg(CString str) { m_strBg = str; };
...
private:
	...
	void InterpriteScript(CScript& script, CPtrArray& ptrArray, bool bAllOpen = false);
...
#endif // __IMPROVE_QUEST_INTERFACE
	void LoadTreeScript( LPCTSTR lpFileName, bool bAllOpen = false);
	BOOL Create(DWORD dwTextStyle,const RECT& rect,CWndBase* pParentWnd,UINT nID);
#if __VER >= 15 // __IMPROVE_QUEST_INTERFACE
