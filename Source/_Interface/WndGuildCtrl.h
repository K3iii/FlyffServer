...
#if !defined(AFX_WNDGUILDCTRL_H__0B45596D_70D7_48A4_BCB2_3D0F32F58E57__INCLUDED_)
#define AFX_WNDGUILDCTRL_H__0B45596D_70D7_48A4_BCB2_3D0F32F58E57__INCLUDED_
...
class CWndGuildCtrl : public CWndBase
{
...
//nt           m_nExpert;
	...
	CItemElem*    m_apItem;
	LPDWORD       m_apItemIdx;
	LPDWORD       m_pdwNumItem;
	DWORD         m_dwMaxItem;
	*/
	DWORD         m_dwListCtrlStyle;

	int GetSelect( CPoint point, CGuildMember ** lppGuildMember );
	u_long GetSelectId( int SelectCount );
	void	GetSelectFriend( int SelectCount, CGuildMember ** lppGuildMember );
