...
////////////////////////////////////////////////// AUTH_GENERAL end///////////////////////////////////////////////
	...
	ON_TEXTCMDFUNC(TextCmd_Undying2, "undying2", "ud2", "�ݹ���", "�ݹ�", TCM_BOTH, AUTH_ADMINISTRATOR, "�ݹ���")
	ON_TEXTCMDFUNC(TextCmd_NoUndying, "noundying", "noud", "��������", "����", TCM_BOTH, AUTH_ADMINISTRATOR, "���� ����")
	ON_TEXTCMDFUNC(TextCmd_Onekill, "onekill", "ok", "����", "����", TCM_BOTH, AUTH_ADMINISTRATOR, "���� �ѹ濡 ���̱�")
	ON_TEXTCMDFUNC(TextCmd_NoOnekill, "noonekill", "nook", "��������", "����", TCM_BOTH, AUTH_ADMINISTRATOR, "���� �ѹ濡 ���̱� ����")
	ON_TEXTCMDFUNC(TextCmd_AroundKill, "aroundkill", "ak", "����", "��", TCM_SERVER, AUTH_ADMINISTRATOR, "����忡 �ִ� ���� ���̱�")
	ON_TEXTCMDFUNC(TextCmd_Level, "level", "lv", "����", "��", TCM_SERVER, AUTH_ADMINISTRATOR, "���� ���� �ϱ�")
	ON_TEXTCMDFUNC(TextCmd_SkillLevelAll, "skilllevelAll", "slvAll", "��ų������", "������", TCM_BOTH, AUTH_ADMINISTRATOR, "��ų���� ���� �ϱ�")
	ON_TEXTCMDFUNC(TextCmd_BeginQuest, "BeginQuest", "bq", "����Ʈ����", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "����Ʈ ���� [ID]")
	ON_TEXTCMDFUNC(TextCmd_EndQuest, "EndQuest", "eq", "����Ʈ����", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "����Ʈ ���� [ID]")
	ON_TEXTCMDFUNC(TextCmd_RemoveQuest, "RemoveQuest", "rq", "����Ʈ����", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "����Ʈ ���� [ID]")
	ON_TEXTCMDFUNC(TextCmd_RemoveAllQuest, "RemoveAllQuest", "raq", "����Ʈ��ü����", "������", TCM_SERVER, AUTH_ADMINISTRATOR, "����Ʈ ��ü ����")
	ON_TEXTCMDFUNC(TextCmd_RemoveCompleteQuest, "RemoveCompleteQuest", "rcq", "����Ʈ�Ϸ�����", "������", TCM_SERVER, AUTH_ADMINISTRATOR, "����Ʈ �Ϸ� ����")
	ON_TEXTCMDFUNC(TextCmd_Freeze, "freeze", "fr", "����", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "�������� ���ϰ� �ϱ�")
	ON_TEXTCMDFUNC(TextCmd_NoFreeze, "nofreeze", "nofr", "��������", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "�������� ���ϰ� �ϱ� ����")
	ON_TEXTCMDFUNC(TextCmd_PartyLevel, "PartyLevel", "plv", "�شܷ���", "�ط�", TCM_SERVER, AUTH_ADMINISTRATOR, "�شܷ��� ���� �ϱ�")
	ON_TEXTCMDFUNC(TextCmd_GuildStat, "GuildStat", "gstat", "��彺��", "�潺��", TCM_SERVER, AUTH_ADMINISTRATOR, "��� ���Ⱥ���")
	ON_TEXTCMDFUNC(TextCmd_CreateGuild, "createguild", "cg", "������", "���", TCM_SERVER, AUTH_ADMINISTRATOR, "��� ����")
	ON_TEXTCMDFUNC(TextCmd_DestroyGuild, "destroyguild", "dg", "�����ü", "����", TCM_CLIENT, AUTH_ADMINISTRATOR, "��� ��ü")
	...
	ON_TEXTCMDFUNC(TextCmd_GuildCombatClose, "GCClose", "gcclose", "�����ݱ�", "�����", TCM_BOTH, AUTH_ADMINISTRATOR, "������ �ݱ�")
	ON_TEXTCMDFUNC(TextCmd_GuildCombatNext, "GCNext", "gcNext", "��������", "�����", TCM_BOTH, AUTH_ADMINISTRATOR, "������ ����")
	ON_TEXTCMDFUNC(TextCmd_indirect, "indirect", "id", "����", "����", TCM_BOTH, AUTH_ADMINISTRATOR, "��뿡�� �������� ���ϰ� �ϱ�")
	ON_TEXTCMDFUNC(TextCmd_CreateNPC, "createnpc", "cn", "���Ǿ�����", "����", TCM_SERVER, AUTH_ADMINISTRATOR, "npc����")
#if __VER >= 9 // __EVENTLUA
	ON_TEXTCMDFUNC(TextCmd_LuaEventList, "EVENTLIST", "eventlist", "�̺�Ʈ���", "�̺�Ʈ���", TCM_SERVER, AUTH_ADMINISTRATOR, "")
	ON_TEXTCMDFUNC(TextCmd_LuaEventInfo, "EVENTINFO", "eventinfo", "�̺�Ʈ����", "�̺�Ʈ����", TCM_SERVER, AUTH_ADMINISTRATOR, "")
#endif	// __EVENTLUA
	ON_TEXTCMDFUNC(TextCmd_GameSetting, "gamesetting", "gs", "���Ӽ���", "�Լ�", TCM_SERVER, AUTH_ADMINISTRATOR, "���� ���� ����")
	...
	ON_TEXTCMDFUNC(TextCmd_ExpUpStop, "ExpUpStop", "eus", "����ġ����", "���", TCM_SERVER, AUTH_GENERAL, "������� ������ ����ġ ����� ����")

#ifdef __FL_UPDATE_READSTAFF
	ON_TEXTCMDFUNC(TextCmd_LoadServerStaff, "LoadServerStaff", "LSS", "����ġ����", "���", TCM_SERVER, AUTH_ADMINISTRATOR, "������� ������ ����ġ ����� ����")
#endif

#ifdef __FL_FFA
	ON_TEXTCMDFUNC(TextCmd_ReloadFFA, "ReloadFFA", "reloadffa", "����ġ����", "���", TCM_SERVER, AUTH_ADMINISTRATOR, "������� ������ ����ġ ����� ����")
#endif
#ifdef __FL_TDM
	ON_TEXTCMDFUNC(TextCmd_ReloadTDM, "ReloadTDM", "reloadtdm", "����ġ����", "���", TCM_SERVER, AUTH_ADMINISTRATOR, "������� ������ ����ġ ����� ����")
	ON_TEXTCMDFUNC(TextCmd_StartTDM, "StartTDM", "starttdm", "����ġ����", "���", TCM_SERVER, AUTH_ADMINISTRATOR, "������� ������ ����ġ ����� ����")
#endif
	...
	ON_TEXTCMDFUNC(TextCmd_Restart, "RESTART", "restart", "����ġ����", "���", TCM_CLIENT, AUTH_ADMINISTRATOR, "������� ������ ����ġ ����� ����")
