...
static void FreeTileTexture();
	...
	void MoveRectCenter(CRect rect);
	void MovePointCenter(CPoint pt);
	void Move( CPoint pt );
	...
	CPoint GetClientCenter();
	CPoint GetStrCenter(C2DRender* p2DRender,LPCTSTR str);
	CPoint GetStrRectCenter(C2DRender* p2DRender,CRect rect,LPCTSTR str);
