...
{
	static const int TILE_TEXTURE_SIZE_XY = 16;
	static const int MINIMUM_TILE_NUMBER_X = 8;
	static const int MINIMUM_TILE_NUMBER_Y = 6;
	static const int MAXIMUM_TILE_NUMBER_X = 48;
	static const int MAXIMUM_TILE_NUMBER_Y = 34;
