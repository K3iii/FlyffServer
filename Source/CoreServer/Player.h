...
public:
	CPlayer( u_long idPlayer, const CHAR* pszPlayer, const CHAR* pszAccount, DWORD dwAuthKey);
	virtual	~CPlayer();
...
public:
	...
	BOOL		AddPlayer( u_long idPlayer, const CHAR* lpszPlayer, const CHAR* lpszAccount, DWORD dwAuthKey);
