...
#define D3DFVF_DRAWVERTEX (D3DFVF_XYZRHW|D3DFVF_DIFFUSE/*|D3DFVF_TEX1*/)
...
typedef unordered_map< string, CTexture* > CMapTexture;
...
public:
	...
	void AddNumber(D3DXVECTOR3 vPos,DWORD nNumber,DWORD nAttribute);
	void Process();
	void Render();
};
#endif
