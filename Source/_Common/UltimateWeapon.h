...
public:
	...
	int RemoveGem(CUser* pUser, OBJID objItemId, OBJID objItemGem, int nSlot2);
	int  TransWeapon(CUser* pUser, OBJID objItem, OBJID objGem1, OBJID objGem2, OBJID objScroll);
