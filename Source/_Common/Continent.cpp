...
BYTE CContinent::GetContinent( CMover* pMover )
{
	...
	switch( pMover->GetWorld()->m_dwWorldID )
	{
		...
		case WI_WORLD_ARENA:	return CONT_DARKON12;
		case WI_WORLD_GUILDWAR : return CONT_FLARIS;
	}
...
int CContinent::GetContinentIndex( const char* continentName )
{
	...
	else if (strcmp("Estia_envir", continentName) == 0)
	{
		return CONT_ESTIA;
	}
	else if (strcmp("Estia", continentName) == 0)
	{
		return CONT_ESTIA;
	}
	else if (strcmp("Darken", continentName) == 0)
	{
		return TOWN_DARKEN;
	}
	else if (strcmp("Flarinenosple", continentName) == 0)
	{
		return TOWN_FLARINENOSPLE;
	}
	else if (strcmp("Saincity", continentName) == 0)
	{
		return TOWN_SAINCITY;
	}
	else if (strcmp("Kaillun", continentName) == 0)
	{
		return CONT_KAILLUN;
	}
	else if (strcmp("Eliun", continentName) == 0)
	{
		return TOWN_ELIUN;
	}
	else if (strcmp("Bahara", continentName) == 0)
	{
		return CONT_BAHARA;
	}
	else if (strcmp("UpresiaEnt", continentName) == 0)
	{
		return CONT_BAHARA;
	}
