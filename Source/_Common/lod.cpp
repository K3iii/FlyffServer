...
CLandscape::~CLandscape()
{
	...
	for (int i = 0; i < m_aLayer.GetSize(); i++) {
		SAFE_DELETE_CONST((CLandLayer*)m_aLayer.GetAt(i));
	}
}
...
#else
	pd3dDevice->SetSamplerState(1, D3DSAMP_MAXANISOTROPY, g_pD3dApp->m_d3dCaps.MaxAnisotropy);
