                                     ...
                                     int cchDestChar )
{
    ...
    int nResult = MultiByteToWideCharEx( CP_ACP, 0, strSource, -1, wstrDestination, cchDestChar );
                                     ...
                                     int cchDestChar )
{
    ...
    int nResult = WideCharToMultiByteEx( CP_ACP, 0, wstrSource, -1, strDestination,
