...
#define	WI_INSTANCE_LAST_ID			135// ������ �δ� ���̵�� �����ϰ�..
...
#define WI_DUNGEON_VOLCANERED	206 // ������ ���� RED
#define WI_DUNGEON_VOLCANEYELLOW	207 // ������ ���� YELLOW
#define WI_WORLD_ARENA				208 // �Ʒ��� ����
#define	WI_WORLD_MINIROOM			209  // �̴Ϸ�(�Ͽ�¡�ý���)
#define	WI_WORLD_QUIZ			211  //Quiz ����

#define	WI_GUILDHOUSE_SMALL			212  //��� �Ͽ콺 ����
#define	WI_GUILDHOUSE_MIDDLE			213  //��� �Ͽ콺 ����
#define	WI_GUILDHOUSE_LARGE			214  //��� �Ͽ콺 ����
...
#define WI_WORLD_GUILDWAR1TO1_L	244	// ������ 1:1�������� ID

#define WI_WORLD_FFA 245
#define WI_WORLD_TDM 246
